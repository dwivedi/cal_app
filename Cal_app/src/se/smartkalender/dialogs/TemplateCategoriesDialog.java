...
public class TemplateCategoriesDialog extends Activity implements OnTouchListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    CategoryListView elv = new CategoryListView(this, EventsManager.getTemplateCategories(), R.layout.event_item_category, itemClickListener);
	    ll.addView(elv);	    
	}
	...
	OnItemClickListener itemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> a, View v, int position,
				long id) {
			Intent intent = new Intent(TemplateCategoriesDialog.this, EventsTemplateDialog.class);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		globals.addRecordToLog("requestCode="+requestCode+" resultCode="+resultCode);
