package se.smartkalender.widgets;
...
public class TimePicker extends LinearLayout {
	...
	private void initData() {
		...
		if (currentTimeFormate == HOUR_12) {
			hour_display.setText(DateFormat.format("kk", cal.getTime()).toString());
			sendToDisplay();
		} else {
			hour_display.setText(DateFormat.format("kk", cal.getTime()).toString());
			sendToDisplay();
		}
		min_display.setText(DateFormat.format("mm", cal.getTime()).toString());
	}
	...
	public void setCurrentHour(int hours) {		
		cal.set(Calendar.HOUR_OF_DAY, hours);	
		sendToDisplay();
	}

	public void setCurrentMinute(int minutes) {
		cal.set(Calendar.MINUTE, minutes);	
		sendToDisplay();
	}

	public void setIs24HourView(boolean b) {
		setAMPMVisible(!b);
		if (b) this.currentTimeFormate = HOUR_24;	
		else  this.currentTimeFormate = HOUR_12;
		initFilterNumericDigit();
		sendToDisplay();
	}
}
